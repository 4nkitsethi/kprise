...
<header class="hero">
  <div class="hero-grid">
    <div>
      ...
      <div class="htag"><span class="htag-dot"></span><span>Retail</span></div>
      <h1>Store Staff Who Know the Product<br><em>Sell More and Stay Longer.</em></h1>
      <p class="hero-sub">High turnover, distributed stores, and shift-based schedules make classroom training impossible to scale. <strong>MyPass LMS delivers mobile-first product knowledge, onboarding, and compliance training</strong> that every store team member completes on any device, anywhere.</p>
      <div class="hbtns">
      ...
      <div class="trust-row"><div class="tchip"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg><span>No credit card required</span></div><div class="tchip"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg><span>15-day free trial</span></div><div class="tchip"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg><span>Mobile-first learning included</span></div></div>
    </div>
    <div class="hero-img-wrap">
      <img class="hero-img"
        src="https://images.unsplash.com/photo-1441984904996-e0b6ba687e04?w=960&q=80&auto=format&fit=crop"
        alt="Store Staff Who Know the Product Sell More and Stay Longer. — MyPass LMS" loading="eager" width="460" height="420">
      <div class="h-float">
        <div class="hf-dot"></div>
        <div><div class="hf-n">50%</div><div class="hf-l">Reduction in new hire onboarding time with structured retail paths</div></div>
      </div>
    </div>
  </div>
  ...
  <div class="wrap">
    <div class="cx">
      <div class="eyebrow"><span class="ew"></span>Built for Retail Training</div>
      <h2 class="heading">Your Store Team Cannot Train<br><em>In a Classroom. It Has to Be Mobile.</em></h2>
      <p class="lead cx">Retail training delivered in a classroom requires bringing staff together, taking them off the floor, and assuming everyone absorbs the same information from a one-time event. For a distributed workforce on rotating shifts, that model fails before it starts. MyPass LMS delivers training on every device, at any time, in short modules that fit around shift patterns — so product knowledge reaches the floor, not a training folder nobody opens.</p>
    </div>
    <div class="vp-grid"><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 19V6l12-3v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="15" r="3"/></svg></div><div class="vpc-t">Mobile-First Product Knowledge</div><div class="vpc-d">Short, visual product knowledge modules delivered on any smartphone, tablet, or device. New product launches reach every store team member before they face a customer question — not weeks after the product hits the floor.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><div class="vpc-t">Automated Store Staff Onboarding</div><div class="vpc-d">New hire induction starts automatically from their first shift — store policies, health and safety, customer service standards, and product category training assigned immediately. Consistent across every store, every cohort, regardless of manager.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.87 9.5a19.79 19.79 0 01-3.07-8.67A2 2 0 012.81 1h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L7.09 8.91a16 16 0 006 6"/></svg></div><div class="vpc-t">Sales Technique Training</div><div class="vpc-d">Consultative selling, objection handling, upselling frameworks, and customer interaction skills — structured and delivered to every frontline team member regardless of shift or location. Sales technique that was once exclusive to high performers becomes the baseline for all.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><div class="vpc-t">Compliance and Safety Training</div><div class="vpc-d">Health and safety, GDPR, manual handling, food safety, loss prevention, and any sector-specific compliance training — assigned by role automatically, tracked to completion, and audit-ready for every inspection.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></div><div class="vpc-t">Multi-Store Management</div><div class="vpc-d">One platform manages training across every store, region, and country. Area managers see compliance and completion data for their stores. Head office sees unified training performance across the entire estate — all from one console.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></div><div class="vpc-t">AI Course Builder for Retail Content</div><div class="vpc-d">Convert brand guidelines, product catalogues, visual merchandising standards, and supplier training materials into structured SCORM modules automatically. New season product training ready before the product arrives in store.</div></div></div>
    ...
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=880&q=80&auto=format&fit=crop" alt="Your Team Knows the Product Before the Customer Asks. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">Product knowledge training delivered on any device before customer questions</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>Product Knowledge Training</div>
      <h2 class="heading">Your Team Knows the Product<br><em>Before the Customer Asks.</em></h2>
      <p>The most common customer complaint in retail is a store team member who does not know the product. The most common cause is that product training arrived as a PDF briefing the week after launch and was read by three people.</p><p>MyPass LMS delivers short, visual product knowledge modules on any device — smartphone, tablet, or shared screen — in the minutes between customer interactions. New product launches are converted into training using the AI builder and pushed to every team member before the product hits the floor.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Short product modules deliverable on any device in minutes between shifts</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>New launches converted to training and deployed before product reaches the floor</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Completion tracked per store and per team member — gaps visible before they cost sales</div></div>
      <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Product Training Features</a>
    </div>
  </div><div class="frow flip">
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=880&q=80&auto=format&fit=crop" alt="Consistent Onboarding Across Every Store. Every Hire. Every Time. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">Automated onboarding delivers same experience to every new hire every time</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>Store Staff Onboarding</div>
      <h2 class="heading">Consistent Onboarding Across<br><em>Every Store. Every Hire. Every Time.</em></h2>
      <p>In retail chains with high turnover and multiple locations, onboarding quality varies enormously based on store manager and manager availability. One store does a thorough three-day induction.</p><p>MyPass LMS assigns new hire induction automatically from the moment a staff member is added — store policies, health and safety, customer service standards, and product category training in a structured sequence. Every new hire across every store follows the same path regardless of their manager.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Induction assigned automatically on new hire addition — no manager action required</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Same structured experience across every store, every new hire, every cohort</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Completion tracked and compliance evidence stored from the first day of training</div></div>
      <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Onboarding Features</a>
    </div>
  </div><div class="frow">
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1543286386-713bdd548da4?w=880&q=80&auto=format&fit=crop" alt="One Console. Every Store. Every Team Member's Training Status. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">Area manager sees completion and compliance data across all stores in real time</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>Multi-Store Management</div>
      <h2 class="heading">One Console. Every Store.<br><em>Every Team Member's Training Status.</em></h2>
      <p>Retail training management across dozens or hundreds of stores creates a data problem — compliance status lives across spreadsheets in different stores, area managers have no unified view, and head office cannot see actual training performance without chasing regional managers for manual updates.</p><p>MyPass LMS gives area managers a live dashboard for every store in their territory — completion rates, compliance status, and outstanding training by location. Head office sees unified training performance across the entire estate in real time.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Live completion and compliance dashboard per store for every area manager</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Head office sees unified training performance across all stores simultaneously</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Compliance gaps identified and addressed centrally without store manager involvement</div></div>
  ...
  <div class="wrap">
    <div class="cx">
      ...
      <h2 class="heading">What Retail Teams Say<br><em>After Switching to MyPass LMS</em></h2>
    </div>
    <div class="tc-grid">
  ...
  <div class="wrap">
    <div class="cx">
      ...
      <h2 class="heading">Rated by Retail Training<br><em>and L&D Teams Across the Market</em></h2>
  ...
  <div class="wrap">
    ...
    <div class="uc-grid"><div class="ucc"><img src="https://images.unsplash.com/photo-1553413077-190dd305871c?w=700&q=80&auto=format&fit=crop" alt="Compliance Training" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Use Case</span><div class="ucc-t">Compliance Training</div><div class="ucc-d">Mandatory health and safety, GDPR, and sector-specific compliance training — assigned automatically by role, tracked to completion, audit-ready for every inspection.</div><a href="https://kp.kprise.com/use-cases/compliance" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div><div class="ucc"><img src="https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=700&q=80&auto=format&fit=crop" alt="Employee Onboarding" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Use Case</span><div class="ucc-t">Employee Onboarding</div><div class="ucc-d">Structured new hire onboarding that delivers the same experience to every store team member across every location — automatically, from day one.</div><a href="https://kp.kprise.com/use-cases/onboarding" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div><div class="ucc"><img src="https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=700&q=80&auto=format&fit=crop" alt="Sales Enablement" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Use Case</span><div class="ucc-t">Sales Enablement</div><div class="ucc-d">Product knowledge, sales technique, and objection handling training for your frontline team — delivered on mobile, tracked centrally, and refreshed automatically with every new product launch.</div><a href="https://kp.kprise.com/use-cases/sales" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div></div>
  </div>
</section><section class="sec sw">
  <div class="wrap">
    <div class="cx">
      <div class="eyebrow"><span class="ew"></span>Common Questions</div>
      <h2 class="heading">What Retail Teams Ask<br><em>Before Starting Their Free Trial</em></h2>
    ...
    <div class="faq-grid"><div class="fi open"><div class="fi-q">Does MyPass LMS work on mobile devices for store staff?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. MyPass LMS is fully mobile-responsive — every course, assessment, and completion works on any smartphone or tablet without an app to install. Store team members access training on their own device, a shared floor device, or any screen available between customer interactions. Short module formats are designed for the retail environment.</div></div><div class="fi"><div class="fi-q">How does new hire onboarding work across multiple stores?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">New store staff are assigned their induction path automatically when added to the system — store policies, health and safety, customer service standards, and product training in a structured sequence. The same path runs across every store regardless of manager. Completion is tracked per individual, per store, and per region with full compliance evidence stored automatically.</div></div><div class="fi"><div class="fi-q">Can we deploy product knowledge training before a new launch?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. The MyPass LMS AI builder converts product catalogues, brand guidelines, and supplier training materials into structured training modules automatically. New season and new product training can be built and deployed to every store team member before the product arrives in store — not after the customer questions start.</div></div><div class="fi"><div class="fi-q">Can area managers see training data for their stores?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. Area managers have a live dashboard showing completion rates, compliance status, and outstanding training for every store in their territory. Head office has a unified view across the entire estate. When a gap appears in a specific location, training can be assigned and tracked from central without involving the store manager.</div></div><div class="fi"><div class="fi-q">How does compliance training work for retail?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Mandatory compliance training — health and safety, GDPR, manual handling, food safety, loss prevention — is assigned by role automatically when a staff member joins. Compliance status is tracked per individual, per store, and per region. Audit-ready evidence is generated in seconds for any inspection without manual data assembly.</div></div><div class="fi"><div class="fi-q">Is the 15-day trial fully featured for retail use cases?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. Full platform access for 15 days, no credit card required. Build a product knowledge module, set up a new hire onboarding path, configure multi-store management, and test compliance reporting before committing. <a href='https://mypasslms.us/login#register' style='color:var(--b);font-weight:700'>Start your free trial here</a>.</div></div></div>
  </div>
</section><section class="cta-sec">
  <div class="cta-in">
    <div class="cta-tag">15-Day Free Trial — No Card Required</div>
    <h2 class="cta-h">A Store Team That Knows the Product<br><em>Converts More and Churns Less.</em></h2>
    <p class="cta-p">Product knowledge that reaches the floor before the customer asks. Onboarding that is consistent across every store and every hire. Compliance that is always audit-ready. Multi-store visibility that removes the data chase from every area manager's week. All from one mobile-first platform.</p>
    <div class="cta-btns">
      <a href="https://mypasslms.us/login#register" class="btn-a">Start Free for 15 Days</a>

...
.lead{font-size:16px;color:var(--ink3);line-height:1.76;max-width:1200px}
...
/* ── FEATURE ROWS ── */
.feat-wrap{max-width:1400px;margin:0 auto;display:flex;flex-direction:column;gap:72px;padding:40px 48px 68px}
...
<header class="hero">
  <div class="hero-grid">
    <div>
      ...
      <div class="htag"><span class="htag-dot"></span><span>Healthcare</span></div>
      <h1>Compliance That Keeps Clinicians<br><em>Trained, Certified, and Audit-Ready.</em></h1>
      <p class="hero-sub">Licence lapses, missed mandatory training, and outdated clinical skills create regulatory risk and patient safety failures. <strong>MyPass LMS automates clinical compliance, CE tracking, and accreditation reporting</strong> so every clinician stays current — without your team chasing anyone.</p>
      <div class="hbtns">
  ...
  <div class="wrap">
    <div class="cx">
      <div class="eyebrow"><span class="ew"></span>Built for Healthcare Training</div>
      <h2 class="heading">Clinical Compliance Is Not Optional.<br><em>And Manual Tracking Is Not Good Enough.</em></h2>
      <p class="lead cx">Every healthcare organisation manages mandatory training that directly affects patient safety, regulatory standing, and accreditation status. Tracking it manually — across departments, roles, locations, and licence renewal cycles — creates gaps that audits surface and patients experience. MyPass LMS automates the entire compliance cycle so nothing falls through.</p>
    </div>
    <div class="vp-grid"><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div><div class="vpc-t">Clinical Compliance Automation</div><div class="vpc-d">Mandatory training assigned by clinical role automatically. Compliance status visible per staff member, department, and facility in real time — no spreadsheet reconciliation before every inspection.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="8" r="6"/><path d="M15.477 12.89L17 22l-5-3-5 3 1.523-9.11"/></svg></div><div class="vpc-t">CE and Licence Renewal Tracking</div><div class="vpc-d">CE credit hours recorded per module completion. Licence renewal reminders sent automatically before deadlines. Every clinician's continuing education status always current and always visible.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 19V6l12-3v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="15" r="3"/></svg></div><div class="vpc-t">Role-Based Clinical Paths</div><div class="vpc-d">Physicians, nurses, allied health, and administrative staff each receive the mandatory and development training their role requires — assigned automatically based on their position and department.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></div><div class="vpc-t">Accreditation-Ready Reporting</div><div class="vpc-d">Generate Joint Commission, CMS, or internal accreditation evidence in seconds. Every completion timestamped and stored automatically — never manually assembled again before an inspection.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/></svg></div><div class="vpc-t">AI Clinical Course Builder</div><div class="vpc-d">Convert clinical guidelines, protocols, and policy documents into structured SCORM training modules automatically. New compliance requirements deployed as training the same day they are issued.</div></div><div class="vpc"><div class="vpc-ic"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div><div class="vpc-t">Multi-Site Staff Management</div><div class="vpc-d">Manage training across multiple facilities, wards, and outpatient locations from one administrative console. Each site sees its own compliance dashboard — central governance with local visibility.</div></div></div>
    ...
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1504813184591-01572f98c85f?w=880&q=80&auto=format&fit=crop" alt="Mandatory Training That Tracks Itself. So Your Team Tracks Patients. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">Compliance dashboard shows every clinician's status in real time</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>Clinical Compliance</div>
      <h2 class="heading">Mandatory Training That Tracks Itself.<br><em>So Your Team Tracks Patients.</em></h2>
      <p>Healthcare compliance is not a once-a-year exercise. Infection control, safeguarding, manual handling, fire safety, data protection, and clinical updates all have different renewal cycles — and a lapse in any of them creates regulatory risk that audit committees and accreditation bodies take seriously.</p><p>MyPass LMS assigns mandatory training by clinical role automatically, tracks completion against deadlines in real time, and fires renewal reminders before certificates expire. Your compliance manager sees every clinician's status at a glance — not by checking a spreadsheet the night before an inspection.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Role-based mandatory training assigned automatically on hire or role change</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Renewal reminders sent on configured schedule before licence or certificate expiry</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Compliance dashboard filterable by facility, ward, department, or individual staff member</div></div>
    ...
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=880&q=80&auto=format&fit=crop" alt="CE Credits That Record Themselves. No Spreadsheet. No Manual Entry. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">CE credit hours recorded automatically on every module completion</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>CE and Licence Tracking</div>
      <h2 class="heading">CE Credits That Record Themselves.<br><em>No Spreadsheet. No Manual Entry.</em></h2>
      <p>Continuing education tracking for clinical staff is one of the most time-consuming administrative tasks in any healthcare organisation. Reconciling CE hours from multiple sources, verifying licence status, and assembling evidence for regulatory bodies takes weeks when it is done manually.</p><p>MyPass LMS records CE credit hours automatically the moment a clinician completes a qualifying module. Every hour is logged, visible to administrators in real time, and exportable for regulatory submission.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>CE and CEU hours recorded and credited per module completion automatically</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Licence renewal reminders sent before deadlines on a schedule your team configures</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>CE evidence exportable for regulatory submission in seconds at any time</div></div>
      <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See CE Tracking Features</a>
    </div>
  </div><div class="frow">
    <div class="frow-img">
      <img src="https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=880&q=80&auto=format&fit=crop" alt="Evidence for Every Inspection. Always Ready. Never Assembled Manually. — MyPass LMS" loading="lazy" width="560" height="380">
      <div class="frow-badge"><span class="fb-ok"></span><span class="fb-t">Accreditation evidence generated in seconds from live data</span></div>
    </div>
    <div class="frow-txt">
      <div class="eyebrow"><span class="ew"></span>Accreditation Reporting</div>
      <h2 class="heading">Evidence for Every Inspection.<br><em>Always Ready. Never Assembled Manually.</em></h2>
      <p>Preparing for a Joint Commission review, CMS audit, or internal accreditation assessment used to mean weeks of data extraction, spreadsheet consolidation, and manual verification. MyPass LMS eliminates all of that entirely.</p><p>Every training event is recorded and timestamped from day one. When an inspection team arrives or an accreditation body requests evidence, your compliance team generates a filtered, formatted report in seconds.</p>
      <div class="fpts"><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Complete training records with timestamps for every staff member and module</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Filtered reports by facility, department, role, date range, or certification type</div><div class="fp"><svg viewBox="0 0 16 16" fill="none" stroke="#16A34A" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 8l4 4 8-8"/></svg>Always current — no preparation needed before inspections or accreditation reviews</div></div>
  ...
  <div class="wrap">
    <div class="cx">
      ...
      <h2 class="heading">What Healthcare Teams Say<br><em>After Switching to MyPass LMS</em></h2>
    </div>
    <div class="tc-grid">
  ...
  <div class="wrap">
    <div class="cx">
      ...
      <h2 class="heading">Rated by Healthcare Training<br><em>and L&D Teams Across the Market</em></h2>
  ...
  <div class="wrap">
    ...
    <div class="int-grid"><div class="int-card"><div class="int-icon"><svg width="24" height="24" viewBox="0 0 26 26" fill="none" aria-hidden="true"><rect x="3" y="3" width="9" height="9" rx="2" fill="#4220C8"/><rect x="14" y="3" width="9" height="9" rx="2" fill="#4220C8" opacity=".5"/><rect x="3" y="14" width="9" height="9" rx="2" fill="#4220C8" opacity=".5"/><rect x="14" y="14" width="9" height="9" rx="2" fill="#4220C8"/></svg></div><div class="int-name">Okta SSO</div><div class="int-desc">Single sign-on for frictionless clinical staff access</div></div><div class="int-card"><div class="int-icon"><svg width="24" height="24" viewBox="0 0 26 26" fill="none" aria-hidden="true"><circle cx="13" cy="13" r="10" stroke="#4220C8" stroke-width="2.5"/><path d="M13 7v6l4 2" stroke="#4220C8" stroke-width="2" stroke-linecap="round"/></svg></div><div class="int-name">Azure AD</div><div class="int-desc">Microsoft identity for health systems on M365</div></div><div class="int-card"><div class="int-icon"><svg width="24" height="24" viewBox="0 0 26 26" fill="none" aria-hidden="true"><path d="M13 4C8 4 4 8 4 13s4 9 9 9 9-4 9-9-4-9-9-9z" stroke="#4220C8" stroke-width="2.2"/><path d="M4 13h18M13 4c-2.5 3-4 5.8-4 9s1.5 6 4 9" stroke="#4220C8" stroke-width="1.6"/></svg></div><div class="int-name">BambooHR</div><div class="int-desc">New clinical staff auto-enrolled on their first day</div></div><div class="int-card"><div class="int-icon"><svg width="24" height="24" viewBox="0 0 26 26" fill="none" aria-hidden="true"><rect x="3" y="6" width="20" height="14" rx="3" stroke="#4220C8" stroke-width="2.2"/><path d="M8 12h10M8 16h6" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round"/></svg></div><div class="int-name">Zoom</div><div class="int-desc">Blended live clinical training alongside online modules</div></div><div class="int-card"><div class="int-icon"><svg width="24" height="24" viewBox="0 0 26 26" fill="none" aria-hidden="true"><path d="M13 3L4 8v5c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V8L13 3z" stroke="#4220C8" stroke-width="2.2" stroke-linejoin="round"/><path d="M9 13l3 3 5-5" stroke="#4220C8" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg></div><div class="int-name">SCORM / xAPI</div><div class="int-desc">Import any existing clinical training content immediately</div></div></div>
  ...
  <div class="wrap">
    ...
    <div class="uc-grid"><div class="ucc"><img src="https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=700&q=80&auto=format&fit=crop" alt="Manufacturing" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Industry</span><div class="ucc-t">Manufacturing</div><div class="ucc-d">Safety compliance and skills training for manufacturing teams — automated, tracked, and audit-ready across every facility and shift.</div><a href="https://kp.kprise.com/industries/manufacturing" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div><div class="ucc"><img src="https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=700&q=80&auto=format&fit=crop" alt="Compliance Training" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Use Case</span><div class="ucc-t">Compliance Training</div><div class="ucc-d">Manage mandatory regulatory training across every department and role. Automated assignment, tracking, and evidence generation for any compliance framework.</div><a href="https://kp.kprise.com/use-cases/compliance" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div><div class="ucc"><img src="https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=700&q=80&auto=format&fit=crop" alt="Continuous Learning" loading="lazy" width="360" height="148"><div class="ucc-body"><span class="ucc-tag">Use Case</span><div class="ucc-t">Continuous Learning</div><div class="ucc-d">Keep clinical skills current with structured, role-based continuing education programmes that run automatically alongside mandatory compliance.</div><a href="https://kp.kprise.com/use-cases/upskilling" class="ucc-link">Read more <svg viewBox="0 0 12 12" fill="none" stroke="#4220C8" stroke-width="2.5" aria-hidden="true"><polyline points="3 2 9 6 3 10"/></svg></a></div></div></div>
  </div>
</section><section class="sec sw">
  <div class="wrap">
    <div class="cx">
      <div class="eyebrow"><span class="ew"></span>Common Questions</div>
      <h2 class="heading">What Healthcare Teams Ask<br><em>Before Starting Their Free Trial</em></h2>
    ...
    <div class="faq-grid"><div class="fi open"><div class="fi-q">How does mandatory clinical compliance training work?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">You configure mandatory training by role — nurses, physicians, allied health, administrative staff — and MyPass LMS assigns the right courses automatically when a staff member joins or changes role. Deadlines are tracked, reminders fire automatically before expiry, and compliance status is visible per individual, department, and facility in real time.</div></div><div class="fi"><div class="fi-q">Can we track CE credits for licence renewal?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. CE credit hours are recorded automatically when a clinician completes a qualifying module. Renewal reminders fire on a schedule you configure before licence or certificate deadlines. Your compliance team has a live view of every staff member's CE status without any manual tracking.</div></div><div class="fi"><div class="fi-q">How quickly can we generate accreditation evidence?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Instantly. Every training completion is timestamped and stored from day one. Filtered reports for Joint Commission, CMS, or internal accreditation reviews are generated in seconds — by facility, department, role, individual, or date range. No manual assembly, no spreadsheet consolidation.</div></div><div class="fi"><div class="fi-q">Does MyPass LMS support multi-site healthcare organisations?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. You manage training across all facilities from one administrative console. Each site has its own compliance dashboard and visibility, while your central governance team sees unified reporting across all locations simultaneously.</div></div><div class="fi"><div class="fi-q">Can we build clinical training from existing protocols and guidelines?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. The MyPass LMS AI builder converts any PDF, Word document, or clinical protocol into a structured SCORM module with assessments automatically. New compliance requirements are deployed as training the same day they are issued — without waiting for an instructional designer.</div></div><div class="fi"><div class="fi-q">Is the 15-day trial fully featured for healthcare compliance use cases?<div class="fi-t"><svg viewBox="0 0 14 14" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="7" y1="2" x2="7" y2="12"/><line x1="2" y1="7" x2="12" y2="7"/></svg></div></div><div class="fi-a">Yes. Full platform access for 15 days, no credit card required. Configure role-based mandatory training, test CE tracking, verify accreditation reporting, and build a clinical training module from an existing document before committing. <a href='https://mypasslms.us/login#register' style='color:var(--b);font-weight:700'>Start your free trial here</a>.</div></div></div>
  </div>
</section><section class="cta-sec">
  <div class="cta-in">
    <div class="cta-tag">15-Day Free Trial — No Card Required</div>
    <h2 class="cta-h">Clinical Compliance That Runs<br><em>Without Your Team Running It.</em></h2>
    <p class="cta-p">Every clinician trained, every certificate current, every inspection ready — without your compliance team spending weeks assembling evidence or chasing renewal reminders. MyPass LMS automates the entire clinical training and compliance lifecycle from day one.</p>
    <div class="cta-btns">
      <a href="https://mypasslms.us/login#register" class="btn-a">Start Free for 15 Days</a>

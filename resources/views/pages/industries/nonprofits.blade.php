...
@section('content')
  ...
  <div class="hero-grid">
    <div>
      ...
      <div class="hbtns">
        ...
        <a href="https://mypasslms.us/login#register" class="btn-b">Start Free for 15 Days</a>
      </div>
      <div class="trust-row">
  ...
  <div class="sc"><div class="sc-n">70%</div><div class="sc-l">Less training admin work after AMS-connected deployment</div></div>
  <div class="sc"><div class="sc-n">0</div><div class="sc-l">Manual CSV exports once members sync bidirectionally through the AMS</div></div>
  <div class="sc"><div class="sc-n">94</div><div class="sc-l">Volunteers onboarded in one afternoon — zero manual assignments by the coordinator</div></div>
  <div class="sc"><div class="sc-n">Day 1</div><div class="sc-l">Members, volunteers, and staff training live from the moment your portal is configured</div></div>
  ...
  <div class="cta-in">
    ...
    <p class="cta-note">15-day free trial &middot; No credit card required &middot; AMS integration included &middot; AWS FedRAMP infrastructure</p>
  </div>
</section>

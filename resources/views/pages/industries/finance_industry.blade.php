...
/* ── FEATURE ROWS ── */
.feat-wrap{max-width:1400px;margin:0 auto;display:flex;flex-direction:column;gap:72px;padding:0 48px 68px}
...
.courses-inner{max-width:1400px;margin:0 auto;display:grid;grid-template-columns:1fr 1fr;gap:56px;align-items:center}

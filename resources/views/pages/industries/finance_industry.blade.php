...
.hero h1{font-size:44px;font-weight:900;line-height:1.30;color:var(--ink);margin-bottom:16px}
...
/* ── FEATURE ROWS ── */
.feat-wrap{max-width:1500px;margin:0 auto;display:flex;flex-direction:column;gap:72px;padding:40px 48px 68px}

...
@section('content')
    ...
    <div class="wrap">
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Course Management Features</a>
        </div>
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Reporting Features</a>
        </div>

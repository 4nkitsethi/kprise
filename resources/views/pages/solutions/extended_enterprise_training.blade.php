...
@section('content')
    ...
    <div class="wrap">
        ...
        <a href="{{ route('product.features') }}" class="btn-primary" style="margin-top:18px">See Multi-Tenant Features</a>
        </div>
        ...
        <a href="{{ route('product.features') }}" class="btn-primary" style="margin-top:18px">See External Certification Features</a>
        </div>
    </div><div class="frow">
        <div class="frow-img">
        ...
        <a href="{{ route('product.features') }}" class="btn-primary" style="margin-top:18px">See Unified Reporting Features</a>
        </div>
    </div><div class="frow flip">
        <div class="frow-img">
        ...
        <a href="{{ route('product.features') }}" class="btn-primary" style="margin-top:18px">See Automation Features</a>
        </div>

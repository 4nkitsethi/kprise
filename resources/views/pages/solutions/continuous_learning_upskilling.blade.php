...
@section('content')
    ...
    <div class="wrap">
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See AI Builder Features</a>
        </div>
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Skill Gap Features</a>
        </div>
    </div><div class="frow">
        <div class="frow-img">

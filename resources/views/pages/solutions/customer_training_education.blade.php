...
@section('content')
    ...
    <div class="wrap">
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Branded Portal Features</a>
        </div>
        ...
        <a href="https://kp.kprise.com/about/platform" class="btn-primary" style="margin-top:18px">See Analytics Features</a>
        </div>

      ...
      <div class="slide-content">
        <div class="slide-copy fade-up">
          <div class="slide-badge">
            <span></span> New · Agentic AI Powered
          </div>
          <h1 class="slide-heading">
            Train Smarter.<br><em>Scale Faster.</em><br>Zero Admin Grind.
          </h1>
          ...
          <div class="slide-stats">
            <!-- <div>
              <div class="slide-stat-val">200+</div>
              <div class="slide-stat-label">Organizations</div>
            </div> -->
            <div>
              <div class="slide-stat-val">70%</div>
              <div class="slide-stat-label">Less Admin Work</div>
            </div>
            <div>
              <div class="slide-stat-val">90 Days</div>
              <div class="slide-stat-label">Free Trial</div>
            </div>
          </div>
        </div>
        <div class="slide-visual fade-up delay-3" aria-hidden="true">
          <div style="position:relative;">
            ...
            <div class="visual-float-badge vfb-1">
              <svg viewBox="0 0 24 24" fill="#10B981" aria-hidden="true"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="#10B981" stroke-width="2" stroke-linecap="round"/></svg>
              <span>Auto-assigned to 240 users</span>
            </div>
            <div class="visual-float-badge vfb-2">
              <svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
    ...
    <div class="slide" role="group" aria-label="Slide 2 of 3">
      ...
      <div class="slide-content">
        <div class="slide-copy fade-up">
          ...
          <h1 class="slide-heading">
            One Platform.<br><em style="background:linear-gradient(135deg,#34D399,#3B82F6);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">Endless</em> Possibilities.
          </h1>
          ...
          <div class="slide-stats">
            <div>
              <div class="slide-stat-val">5,000</div>
              <div class="slide-stat-label">Free Credits</div>
            </div>
            <div>
              <div class="slide-stat-val">4×</div>
              <div class="slide-stat-label">Faster Launch</div>
            </div>
            <div>
              <div class="slide-stat-val">99.9%</div>
              <div class="slide-stat-label">Uptime SLA</div>
            </div>
          </div>
        </div>
        <div class="slide-visual fade-up delay-3" aria-hidden="true">
          <div style="position:relative;">
            <div class="slide-card">
              <div style="margin-bottom:16px;">
                ...
                <div style="background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.1);border-radius:10px;padding:12px;font-size:13px;color:rgba(255,255,255,.8);line-height:1.5;">
                  "Create a 5-module cybersecurity course for new hires with quizzes and a final assessment"
                </div>
              </div>
              <div style="display:flex;flex-direction:column;gap:8px;">
                <div style="background:rgba(16,185,129,.15);border:1px solid rgba(16,185,129,.2);border-radius:8px;padding:10px 12px;display:flex;align-items:center;gap:8px;font-size:13px;color:#6EE7B7;">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="#10B981"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="#10B981" stroke-width="2" stroke-linecap="round"/></svg>
                  5 modules generated
                </div>
                <div style="background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.2);border-radius:8px;padding:10px 12px;display:flex;align-items:center;gap:8px;font-size:13px;color:#A5B4FC;">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="#6366F1"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="#6366F1" stroke-width="2" stroke-linecap="round"/></svg>
                  SCORM package ready
                </div>
    ...
    <div class="slide" role="group" aria-label="Slide 3 of 3">
      ...
      <div class="slide-content">
        <div class="slide-copy fade-up">
          ...
          <h1 class="slide-heading">
            Pay For<br><em style="background:linear-gradient(135deg,#A78BFA,#F59E0B);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">Learning Done.</em> Not Seats Idle.
          </h1>
          ...
          <div class="slide-stats">
            <div>
              <div class="slide-stat-val">No</div>
              <div class="slide-stat-label">Per-User Fees</div>
            </div>
            <div>
              <div class="slide-stat-val">35%</div>
              <div class="slide-stat-label">Better Completion</div>
            </div>
            <div>
              <div class="slide-stat-val">2×</div>
              <div class="slide-stat-label">Faster Decisions</div>
            </div>
          </div>
        </div>
        <div class="slide-visual fade-up delay-3" aria-hidden="true">
          <div style="position:relative;">
            <div class="slide-card">
              ...
              <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
                <div style="background:rgba(255,255,255,.06);border-radius:10px;padding:14px;text-align:center;">
                  <div style="font-size:20px;font-weight:800;color:#34D399;font-family:var(--font-display);">∞</div>
                  <div style="font-size:11px;color:rgba(255,255,255,.5);margin-top:4px;">Admins</div>
                </div>
                <div style="background:rgba(255,255,255,.06);border-radius:10px;padding:14px;text-align:center;">
                  <div style="font-size:20px;font-weight:800;color:#60A5FA;font-family:var(--font-display);">∞</div>
                  <div style="font-size:11px;color:rgba(255,255,255,.5);margin-top:4px;">Courses</div>
                </div>
                <div style="background:rgba(255,255,255,.06);border-radius:10px;padding:14px;text-align:center;">
                  <div style="font-size:20px;font-weight:800;color:#FBBF24;font-family:var(--font-display);">AI</div>
                  <div style="font-size:11px;color:rgba(255,255,255,.5);margin-top:4px;">Included</div>
                </div>
                <div style="background:rgba(255,255,255,.06);border-radius:10px;padding:14px;text-align:center;">
                  <div style="font-size:20px;font-weight:800;color:#F472B6;font-family:var(--font-display);">SSO</div>
                  <div style="font-size:11px;color:rgba(255,255,255,.5);margin-top:4px;">All Plans</div>
                </div>
              </div>
            </div>
            <div class="visual-float-badge vfb-1">
            ...
            <div class="visual-float-badge vfb-2">
              <svg viewBox="0 0 24 24" fill="none" stroke="#8B5CF6" stroke-width="2" width="16" height="16"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg>
    ...
    <div class="hero-showcase">
      <div class="hero-video-wrap">
        <div class="hero-video-inner">
          ...
          <video src="https://kprise.com/wp-content/uploads/2025/10/WhatsApp-Video-2025-10-06-at-12.39.50_fe04276f.mp4" autoplay="" muted="" loop="" playsinline="" aria-label="MyPass LMS platform walkthrough showing course creation, enrollment automation, and compliance reporting"></video>
        </div>
      </div>
    ...
    <div class="platform-grid">
      <div class="platform-copy">
        ...
        <div class="platform-bullets">
          <div class="platform-bullet" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 160ms, transform 0.5s 160ms;">
            <div class="bullet-icon" style="background:#EEF2FF;">
              <svg viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"></path><path d="M2 17l10 5 10-5"></path><path d="M2 12l10 5 10-5"></path></svg>
            </div>
            <div>
          ...
          <div class="platform-bullet" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 240ms, transform 0.5s 240ms;">
            <div class="bullet-icon" style="background:#D1FAE5;">
              <svg viewBox="0 0 24 24" fill="none" stroke="#10B981" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75"></path></svg>
            </div>
            <div>
          ...
          <div class="platform-bullet" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s, transform 0.5s;">
            <div class="bullet-icon" style="background:#FEF3C7;">
              <svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg>
            </div>
            <div>
          ...
          <div class="platform-bullet" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s 80ms;">
            <div class="bullet-icon" style="background:#EDE9FE;">
              <svg viewBox="0 0 24 24" fill="none" stroke="#7C3AED" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0110 0v4"></path></svg>
            </div>
            <div>
      ...
      <div class="platform-visual">
        ...
        <div class="plat-float plat-float-1">
          <div class="pf-icon" style="background:#D1FAE5;"><svg viewBox="0 0 24 24" fill="none" stroke="#10B981" stroke-width="2" width="18" height="18"><path d="M22 11.08V12a10 10 0 11-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01" fill="none" stroke="#10B981" stroke-width="2" stroke-linecap="round"></polyline></svg></div>
          <div><div class="pf-val">8 hrs</div><div class="pf-lbl">Saved this week</div></div>
        </div>
        <div class="plat-float plat-float-2">
          <div class="pf-icon" style="background:#EEF2FF;"><svg viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="2" width="18" height="18"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 00-3-3.87"></path></svg></div>
...
<div class="trust-strip" aria-label="Trusted by companies">
  <div class="container">
    ...
    <div class="marquee-wrap">
        ...
        <div class="marquee-item"><div class="marquee-logo" style="background:#EEF2FF;"><svg viewBox="0 0 24 24" fill="none" stroke="#4F46E5" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"></rect><path d="M9 9h6M9 12h6M9 15h4"></path></svg></div>Acme Corp</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#D1FAE5;"><svg viewBox="0 0 24 24" fill="none" stroke="#10B981" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4l3 3"></path></svg></div>NovaTech</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#FEF3C7;"><svg viewBox="0 0 24 24" fill="none" stroke="#F59E0B" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"></path><path d="M2 17l10 5 10-5"></path></svg></div>Buildify</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#FEE2E2;"><svg viewBox="0 0 24 24" fill="none" stroke="#EF4444" stroke-width="2"><path d="M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2z"></path></svg></div>HealthPlus</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#EDE9FE;"><svg viewBox="0 0 24 24" fill="none" stroke="#7C3AED" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"></path><circle cx="9" cy="7" r="4"></circle></svg></div>PeopleFirst</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#CFFAFE;"><svg viewBox="0 0 24 24" fill="none" stroke="#0891B2" stroke-width="2"><path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.8 19.79 19.79 0 01.22 1.18 2 2 0 012.2 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.09a16 16 0 006 6l.56-.56a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.92z"></path></svg></div>CallMax</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#F0FDF4;"><svg viewBox="0 0 24 24" fill="none" stroke="#16A34A" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"></path></svg></div>HomeBase</div>
        <div class="marquee-item"><div class="marquee-logo" style="background:#FFF7ED;"><svg viewBox="0 0 24 24" fill="none" stroke="#EA580C" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg></div>StarReach</div>
...
<section class="section" id="purpose" aria-labelledby="purpose-title">
  <div class="container">
    ...
    <div class="purpose-grid">
      <div class="purpose-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 160ms, transform 0.5s 160ms;">
      ...
      <div class="purpose-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 240ms, transform 0.5s 240ms;">
      ...
      <div class="purpose-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s, transform 0.5s;">
      ...
      <div class="purpose-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s 80ms;">
    ...
    <div class="container">
        ...
        <div class="comparison__table-wrap" role="region" aria-label="Feature comparison table" tabindex="0">
            <table class="comparison__table">
                ...
                <tbody>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Course Creation &amp; Assignment</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Manual — time-consuming</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                        <circle cx="8" cy="8" r="8" fill="#5932EA" fill-opacity="0.1"></circle>
                                        <path d="M5 8l2 2 4-4" stroke="#5932EA" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                    Done in minutes — slash admin hours
                                </span>
                            </td>
                        </tr>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 160ms, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Task Execution</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">No chat/voice control</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    Natural chat &amp; voice — describe task, MyPass LMS executes
                                </span>
                            </td>
                        </tr>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Content → Course</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Upload only — needs external authoring</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    Upload PPT/PDF/Video — AI auto-creates SCORM
                                </span>
                            </td>
                        </tr>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Scheduling &amp; Reminders</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Manual reminders</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    Automatic scheduling &amp; reminders
                                            ...
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 160ms, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Compliance &amp; Deadlines</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Missed alerts; higher risk</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    Alerting &amp; deadline tracking
                                </span>
                            </td>
                        </tr>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Enrollment</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Manual per team</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    Auto-enroll by roles/groups
                                </span>
                            </td>
                        </tr>
                                            <tr class="comparison__row " style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s;">
                            <td class="comparison__td comparison__td--feature">Toolset</td>
                            <td class="comparison__td comparison__td--col-a">
                                <span class="comparison__neg">Fragmented tools</span>
                            </td>
                            <td class="comparison__td comparison__td--col-b">
                                <span class="comparison__pos">
                                    <svg class="comparison__check" width="16" height="16" viewBox="0 0 16 16" aria-hidden="true">
                                    ...
                                    All-in-one: SCORM, ILT, assessments, SSO, reporting
                                </span>
                            </td>
                        </tr>
                                    </tbody>
...
<section class="section" id="courses" aria-labelledby="courses-title">
  <div class="container">
    ...
    <div class="courses-grid">
      ...
      <article class="course-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s, transform 0.5s;">
      ...
      <article class="course-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 80ms, transform 0.5s 80ms;">
        <div class="course-thumb">
      ...
      <article class="course-card" style="opacity: 1; transform: translateY(0px); transition: opacity 0.5s 160ms, transform 0.5s 160ms;">
        <div class="course-thumb">
...
<section class="cta-section">
  <div class="container">
    <div class="cta-box reveal visible">
